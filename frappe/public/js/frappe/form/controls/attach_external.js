frappe.ui.form.ControlAttachExternal = class ControlAttach extends frappe.ui.form.ControlData {
	// TODO: add docstring
	make_input() {
		let me = this;
		this.$input = $('<button class="btn btn-default btn-sm btn-attach-external">')
			.html(__("Attach"))
	...
	on_attach_click() {
		...
		this.file_uploader = new frappe.ui.FileUploaderExternal(this.upload_options);
	}
	on_attach_doc_image() {
		this.set_upload_options();
	...
	async on_upload_complete(attachment) {
		if (this.frm) {
			await this.parse_validate_and_set_in_model(attachment);
